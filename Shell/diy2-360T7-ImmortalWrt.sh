...
FIREWALL_21_3(){
  ...
  svn co https://github.com/immortalwrt/immortalwrt/branches/openwrt-21.02/package/network/config/firewall
  mv firewall package/network/config/firewall4
  ls -al package/network/config/
}
...
FIREWALL_23_3(){
  ...
  rm -rf package/network/config/firewall4
  ls -al package/network/config/
  cp -r package/network/config/firewall package/network/config/firewall4
  ls -al package/network/config/
}
